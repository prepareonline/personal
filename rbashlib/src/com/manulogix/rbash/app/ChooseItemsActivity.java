...
public class ChooseItemsActivity extends FragmentActivity {
	...
	ImageButton btMenu;
	TextView tvTitle;
	private ChooseItemsActivity thisActivity;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		...
		FragmentManager fm = ChooseItemsActivity.this.getSupportFragmentManager();
	...
	private void loadLoginData() throws Exception {
		...
		/*
		 * Gson gson= new Gson(); String jsonString=gson.toJson(request);
		 * 
